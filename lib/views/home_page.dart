...
class HomePage extends StatelessWidget {
  ...
  static const List<Map<String, dynamic>> sampleElectronicsProducts = [
    {
      "id": 9,
  ...
  static const List<Map<String, dynamic>> sampleJeweleryProducts = [
    {
      "id": 5,
      "title":
          "John Hardy Women's Legends Naga Gold & Silver Dragon Station Chain Bracelet",
  ...
  static const List<Map<String, dynamic>> sampleMensClothingProducts = [
    {
      "id": 1,
      "title": "Fjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops",
      "price": 109.95,
  ...
  static const List<Map<String, dynamic>> sampleWomensClothingProducts = [
    {
      "id": 15,
        ...
        child: CustomScrollView(
          ...
          slivers: [
            ...
            HomePageButtonsRow(
              ...
              electronicsProducts: sampleElectronicsProducts,
              jeweleryProducts: sampleJeweleryProducts,
              mensClothingProducts: sampleMensClothingProducts,
              womensClothingProducts: sampleWomensClothingProducts,
            ),
            SliverToBoxAdapter(
              child: SizedBox(
                height: 20,
