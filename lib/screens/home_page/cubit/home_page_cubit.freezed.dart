...
abstract class _$$SuccessImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<HomePageProduct> products});
}
...
class _$SuccessImpl implements _Success {
  const _$SuccessImpl(final List<HomePageProduct> products)
      : _products = products;

  final List<HomePageProduct> _products;
  @override
  List<HomePageProduct> get products {
  ...
  @override
  String toString() {
    return 'HomePageState.success(products: $products)';
  }
...
abstract class _Success implements HomePageState {
  const factory _Success(final List<HomePageProduct> products) = _$SuccessImpl;
